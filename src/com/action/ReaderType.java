...
public class ReaderType extends HttpServlet {
	...
	private void readerTypeAdd(HttpServletRequest request,
		...
		readerTypeForm.setName(new String(request.getParameter("name").getBytes("ISO-8859-1"),"UTF-8"));
		readerTypeForm.setNumber(Integer.parseInt(request.getParameter("number")));
