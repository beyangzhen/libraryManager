...
public class Book extends HttpServlet {
	...
	private void bookAdd(HttpServletRequest request,
		...
		bookForm.setBookName(request.getParameter(new String(request.getParameter("bookName").getBytes("ISO-8859-1"),"UTF-8")));
		...
		bookForm.setBookcaseid(Integer.parseInt(request.getParameter("bookcaseid")));
		// 获取系统日期
		Date date1 = new Date();
