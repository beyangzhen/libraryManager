...
public class Reader extends HttpServlet {
	...
	private void readerAdd(HttpServletRequest request,
		...
		readerForm.setName(new String(request.getParameter("name").getBytes("ISO-8859-1"),"UTF-8"));
		readerForm.setSex(new String(request.getParameter("sex").getBytes("ISO-8859-1"),"UTF-8"));
		...
		readerForm.setPaperType(new String(request.getParameter("paperType").getBytes("ISO-8859-1"),"UTF-8"));
