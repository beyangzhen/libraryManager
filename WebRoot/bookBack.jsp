...
<section>
<div id="area">&nbsp;当前位置：图书借还 &gt; 图书归还 &gt;&gt;&gt;</div>
                    ...
                    <td><table width="90%" height="21" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="76%" style="padding-top:7px;">读者条形码：
                            ...
                            &nbsp;
                            <input name="Button" type="button" value="确定" onClick="checkreader(form1)"></td>
                        </tr>
                    </table></td>
                  </tr>
                  <tr>
          ...
          <tr>
            <td valign="top"><table width="100%" height="35" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#F6B83B" bgcolor="#FFFFFF">
                <tr align="center" bgcolor="#e3F4F7">
                  ...
                  <td width="12%" bgcolor="#FFF9D9"><input name="Button22" type="button" value="完成归还" onClick="window.location.href='bookBack.jsp'"></td>
                </tr>
                <%
int id=0;
String bookname="";
